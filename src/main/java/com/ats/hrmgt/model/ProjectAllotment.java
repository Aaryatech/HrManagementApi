...
public class ProjectAllotment {
	...
	public String toString() {
		return "ProjectAllotment [pallotId=" + pallotId + ", projectId=" + projectId + ", empId=" + empId
				+ ", pallotFromdt=" + pallotFromdt + ", pallotTodt=" + pallotTodt + ", pallotDailyHrs=" + pallotDailyHrs
				+ ", pallotRemarks=" + pallotRemarks + ", delStatus=" + delStatus + ", isActive=" + isActive
